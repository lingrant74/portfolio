...
export function Home() {
    return (
        <main className='flex justify-center mt-14 px-41 flex-col mb-40 min-w-320'>
            <div className='w-full h-150 bg-green-100 relative overflow-hidden shadow-lg'>
            ...
            <section id="about" className="scroll-mt-[0px]">
                <div className='h-150 w-full mt-38 flex relative left-0 '>
                    <div className=' w-7/12 h-full overflow-hidden aspect-[5/7]'>
                        <img className= 'w-7/8 max-w-150 object-fit' src={selfie} alt = "image of myself"/>
                    </div>
