            ...
            <div className='mt-29 w-full flex h-300'>
                <div className='w-5/12 pr-20'>
                    ...
                    <a href="https://tourmaline-malasada-1fb272.netlify.app/">
                        <button className='mt-18 font-public border-1 border-gray-800 w-50.5 h-12 text-gray-800 cursor-pointer hover:bg-gray-900 hover:text-white
                ...
                <div className='w-7/12'>
                    ...
                    <div className='w-full h-45 mb-10 font-public text-[#33323D] text-[1rem] leading-[30px]'>
